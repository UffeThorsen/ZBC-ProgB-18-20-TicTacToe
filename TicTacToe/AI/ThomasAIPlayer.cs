...
namespace TicTacToe
{
    class ThomasAIPlayer : IPlayer
    {
        ...
        {
            if(gameState.gameBoard.Symbol(x1, y1) == Symbol.X && gameState.gameBoard.Symbol(x2, y2) == Symbol.X || gameState.gameBoard.Symbol(x1, y1) == Symbol.O && gameState.gameBoard.Symbol(x2, y2) == Symbol.O)
            {
                return true;
            }
            else
